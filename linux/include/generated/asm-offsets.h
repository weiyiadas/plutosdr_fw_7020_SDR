...
#define TSK_STACK_CANARY 784 /* offsetof(struct task_struct, stack_canary) */
...
#define TI_ABI_SYSCALL 72 /* offsetof(struct thread_info, abi_syscall) */
...
#define TI_STACK_CANARY 20 /* offsetof(struct thread_info, stack_canary) */
